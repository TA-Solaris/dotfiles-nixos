...
nix run nix-darwin --extra-experimental-features nix-command --extra-experimental-features flakes -- switch --flake ~/.dotfiles#[configuration] --use-remote-sudo
```
...
**Darwin**
```bash
darwin-rebuild switch --flake ~/.dotfiles#[configuration] --use-remote-sudo
```
